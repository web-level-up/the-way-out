...
export const getAllMazes = () =>
  sql`SELECT m.id, m.maze_layout_url, m.difficulty_level_id as difficulty_id, d.difficulty_level_name as difficulty_name, d.preview_time_seconds, d.escape_time_seconds, m.starting_position, m.ending_position FROM mazes m INNER JOIN difficulty_levels d ON m.difficulty_level_id = d.id`;
